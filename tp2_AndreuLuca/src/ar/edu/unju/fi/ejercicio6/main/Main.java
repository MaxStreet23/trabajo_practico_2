...
public class Main {
	public static void main(String[] args) {
		...
		Converter<FelinoDomestico, FelinoSalvaje> converter1= t -> new FelinoSalvaje(t.getNombre(), t.getEdad(), t.getPeso());
		...
		Converter<FelinoSalvaje, FelinoDomestico> converter2= t2 -> new FelinoDomestico(t2.getNombre(), t2.getEdad(), t2.getPeso());
